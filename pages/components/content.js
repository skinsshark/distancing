    ...
    <main>
      ...
      <section className="singular instr">
        <article>
          ...
          <h4>
            No visual cues or visible on-screen indicators by default, so it's on you to spread the word and tell your users of the feature. I know we weren't prepared for this and text input without visual feedback is hard, but I guess that's also how social distancing is
          </h4>
        </article>
      </section>
